...
void main() {
  test('Scraper fetches comic detail', () async {
    ...
    final detail = await scraper
        .getComicDetail('https://komiku.org/manga/superstar-from-age-0/');
  ...
  test('Scraper fetches chapter images', () async {
    final scraper = KomikuScraper();
    final images = await scraper.getChapterImages(
        'https://komiku.org/superstar-from-age-0-chapter-86/');
